...
import FormalSciencesView from './components/FormalSciencesView';
          ...
          <div className="flex-1 min-w-0 py-12">
            <header className="mb-10">
              ...
              <div className="mt-6 flex flex-wrap border-b border-stone-200">
                ...
                <button
                  onClick={() => setAppMode('formalsciences')}
                  className={`px-4 py-2.5 text-sm font-mono -mb-px transition-colors ${
                    appMode === 'formalsciences'
                      ? 'border-b-2 border-amber-600 text-amber-700 font-semibold'
                      : 'border-b-2 border-transparent text-amber-500 hover:text-amber-700'
                  }`}
                >
                  MEGA FORMAL SCIENCES TAXONOMY
                </button>
                <button
              ...
              <p className="mt-4 text-sm text-stone-500 leading-relaxed">
                {appMode === 'canon'
                  ...
                  : appMode === 'formalsciences'
                  ? '9,700+ topics across the 14 formal-science branches — Logic, Mathematics, Statistics, Theoretical CS, AI, Game Theory, Systems Theory, Theoretical Linguistics, Decision Theory, Systems Science, Data Science, Information Theory, Computer Science, and Cryptography. Click any topic for its most-cited works (live OpenAlex data) or a plain-English explanation.'
                  : appMode === 'doctoral'
            ...
            {appMode === 'formalsciences' && <FormalSciencesView onGenerate={handleDoctoralTopicClick} />}
