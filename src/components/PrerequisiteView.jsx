...
export default function PrerequisiteView({ parsed, isStreaming }) {
  ...
  return (
    <div className={`mt-10 ${isStreaming ? 'opacity-90' : ''}`}>
      ...
      {parsed.work && (
        <div className="mb-8">
          <p className="text-xs font-mono text-stone-400 mb-1">Prerequisites</p>
      ...
      {parsed.totalPath && (
        <div className="mt-6 flex items-baseline gap-3 px-5 py-4 bg-stone-900">
          <span className="text-xs font-mono text-stone-400 shrink-0">Total Path</span>
      ...
      {parsed.beyond && (parsed.beyond.summary || parsed.beyond.streams.length > 0) && (
        <div className="mt-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-mono text-stone-400">Postrequisites</span>
            <div className="h-px flex-1 bg-stone-200" />
          </div>
